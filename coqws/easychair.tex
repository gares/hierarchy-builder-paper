...
of the green arrows in Figure~\ref{fig:hierarchy} which are alternative interfaces
called factories. They provide specialized interfaces to
build structures from others.
Factories are used to accommodate the insertion of
intermediate structures in a hierarchy without breaking user code, as well
as to implement shortcuts: e.g. the factory to build a \coq{Ring} from a \coq{Type}
