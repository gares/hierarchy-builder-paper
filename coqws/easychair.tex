...
\begin{abstract}
  We present a tool that makes it easy to declare and evolve hierarchies
...
bla bla librarires.
bla bla structures.
bla bla packed classes.
bla bla difficult.
bla bla HB language.
bla bla imlemented in Elpi.
In the talk we give a demo of the tool, details are in the paper cite FSCD.

\newpage
\section{An example of HB}
