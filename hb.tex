...
type \coq{A} into a monoid, hence we chose the name to be \coq{Monoid_of_Type}.

The \hbstructure{} command takes in input the definition S for a type
\coq{A} together with a list of \factories{} for \coq{A}.
...
#\hbstructure{}# Definition AbelianGroup :=
  { A of Monoid.axioms A & AbelianGroup_of_Monoid.axioms A }.
...
#\hbstructure{}# Definition Ring :=
  { A of AbelianGroup.axioms A & Ring_of_AbelianGroup.axioms A }.
...
\begin{coqcode}
#\hbfactory{}# Record Ring_of_Monoid A of Monoid.axioms A := {
...
\begin{coqcode}
#\hbstructure{}# Definition Ring :=
  { A of Monoid.axioms A & Ring_of_Monoid.axioms A }.
#\hbstructure{}# Definition Ring :=
  { A of AbelianGroup.axioms A & Ring_of_AbelianGroup.axioms A }.
\end{coqcode}
