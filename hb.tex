...
#\hbstructure{}# Definition Monoid := { A of Monoid_of_Type.axioms A }.        #\label{demo:structure:monoid}#

#\hbmixin{}# Record Ring_of_Monoid A of Monoid.axioms A := {       #\label{demo:mixin:rom}#
  one : A;
  opp : A -> A;
  mul : A -> A -> A;
...
#\hbstructure{}# Definition Ring := { A of Monoid.axioms A & Ring_of_Monoid.axioms A }. #\label{demo:structure:ring}#
...
#\hbstructure{}# Definition Monoid := { A & Monoid_of_Type.axioms A }.

#\hbmixin{}# Record AbelianGroup_of_Monoid A of Monoid.axioms A := {
  opp : A -> A;
  addrC : commutative (add : A -> A -> A);
  addNr : left_inverse zero opp add;
}.
#\hbstructure{}# Definition AbelianGroup := { A of Monoid.axioms A & AbelianGroup_of_Monoid.axioms A }.

#\hbmixin{}# Record Ring_of_AbelianGroup A of AbelianGroup.axioms A := {
  one : A;
  mul : A -> A -> A;
...
#\hbstructure{}# Definition Ring := { A of AbelianGroup.axioms A & Ring_of_AbelianGroup.axioms A }.
...
\begin{coqcode}
#\hbfactory{}# Record Ring_of_Monoid A of Monoid.axioms A := { ... (* unchanged, see page 2 line 13 *) ... }.
#\hbbuilders{}# Context A (f : Ring_of_Monoid.axioms A).                          #\label{demo3:variable:f}#
...
\begin{coqcode}
#\hbstructure{}# Definition Ring := { A of Monoid.axioms A & Ring_of_Monoid.axioms A }.
#\hbstructure{}# Definition Ring := { A of AbelianGroup.axioms A & Ring_of_AbelianGroup.axioms A }.
\end{coqcode}
...
\begin{coqcode}
#\hbmixin{}# Record M T #$f_1\ \ldots\ f_n$# := { .. }. #\hbend{}#.
\end{coqcode}
...
\begin{coqcode}
#\hbfactory{}# Record M T #$f_1\ \ldots\ f_n$# := { .. }.
#\hbbuilders{}# Context T (a : M.axioms A).
...
\
\begin{coqcode}
#\hbmixin{}# Record SemiRing_of_Monoid A of Monoid.axioms A := {
  one : A;
  mul : A -> A -> A;
  (* 7 axioms are omitted. *)
}.

#\hbfactory{}# Record Ring_of_AbelianGroup A of AbelianGroup.axioms A := {
