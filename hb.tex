...
The language of Packed Classes~\cite{DBLP:conf/tphol/GarillotGMR09} is used directly to describe the algebraic hierarchy of the Mathematical Components library.
It is based on a disciplined use of records and projections and on the possibility of extending the elaborator of Coq via the declaration of Canonical Structures~\cite{DBLP:conf/itp/MahboubiT13} instances.
In this section, we describe the \emph{flat} variant of Packed Classes, the target language of \hb{}, through the hierarchy V3 extended with semirings.

The \hb{} addon can generate all the Coq declarations in this section automatically, but some details are omitted for brevity in this section.
